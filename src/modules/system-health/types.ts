...
/**
 * `systemHealth/{component}` — FINAL-ARCHITECTURE.md §32 (System Health, Phase 9 foundation).
 ...
 *
 * §32 names seven components but never defines a per-component metric/threshold for any of them.
 ...
 * limitations" for the explicit list of what's deferred.
 */
